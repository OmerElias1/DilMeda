...
const styles = StyleSheet.create({
  ...
  cardHeaderLeft: { flex: 1, flexShrink: 1, gap: 4, minWidth: 0 },
  cardTournamentName: {
  ...
  prizeAmount: { color: colors.gold, fontSize: 13, fontWeight: '900', textAlign: 'center' },
  prizeLabel: { color: colors.gold, fontSize: 8, fontWeight: '700', letterSpacing: 1, opacity: 0.7, textAlign: 'center' },

  // Players
  playersContainer: { backgroundColor: colors.bgCard },
  playerRow: {
  ...
  playerInfo: { flex: 1, flexShrink: 1, gap: 2, minWidth: 0 },
  playerName: { color: colors.textPrimary, fontSize: 13, fontWeight: '800', flexShrink: 1 },
  playerUsername: { color: colors.textMuted, fontSize: 11, flexShrink: 1 },
  contactRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 1, flexWrap: 'nowrap' },
  contactText: { color: colors.textSecondary, fontSize: 11, flex: 1, flexShrink: 1 },
  pointsColumn: { alignItems: 'center', justifyContent: 'center', minWidth: 52, flexShrink: 0 },
  pointsValue: { fontSize: 16, fontWeight: '900', textAlign: 'center' },
  pointsLabel: { color: colors.textMuted, fontSize: 8, fontWeight: '800', letterSpacing: 0.5, textAlign: 'center' },
